          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Data <button class="btn bg-gradient-dark px-3 mb-0 rf-btn active" data-class="bg-gradient-dark" ><a class="text-white" href="{{route('admin.data.add')}}">+ ADD</a></button></h6>
              </div>
            </div>
